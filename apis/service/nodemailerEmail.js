...
export const myEmail=async(options)=> {
  ...
  let transporter = nodemailer.createTransport({
    service:'gmail',
    auth: {
      user: "mojahid.sabbah@gmail.com", // generated ethereal user
      pass: "hccbqytmoauciapi", // generated ethereal password
    },
  });
  // send mail with defined transport object
  let info = await transporter.sendMail({
    from: '"Fadfada App Confrinm Email " <mojahid.sabbah@gmail.com>', // sender address
